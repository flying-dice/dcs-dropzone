...
export class DcsDropzoneContainer extends Container<Env> {
	...
	sleepAfter = "2m";
	envVars = {
		DZ_WEBAPP_MONGO_URI: env.DZ_WEBAPP_MONGO_URI,
		DZ_WEBAPP_USER_COOKIE_SECRET: env.DZ_WEBAPP_USER_COOKIE_SECRET,
		DZ_WEBAPP_AUTH_REDIRECT_URL: env.DZ_WEBAPP_AUTH_REDIRECT_URL,
		DZ_WEBAPP_URL: env.DZ_WEBAPP_URL,
		DZ_WEBAPP_AUTH_SERVICE_GH: env.DZ_WEBAPP_AUTH_SERVICE_GH,
	};
