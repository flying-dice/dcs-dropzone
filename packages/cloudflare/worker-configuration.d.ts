/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 86c87030f370340ebef01c107cc5e5a9)
// Runtime types generated with workerd@1.20260114.0 2025-10-08 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "DcsDropzoneContainer";
	}
	interface Env {
		DZ_WEBAPP_MONGO_URI: string;
		DZ_WEBAPP_USER_COOKIE_SECRET: string;
		DZ_WEBAPP_AUTH_REDIRECT_URL: string;
		DZ_WEBAPP_URL: string;
		DZ_WEBAPP_AUTH_SERVICE_GH: string;
		DCS_DROPZONE_CONTAINER: DurableObjectNamespace<import("./src/index").DcsDropzoneContainer>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DZ_WEBAPP_MONGO_URI" | "DZ_WEBAPP_USER_COOKIE_SECRET" | "DZ_WEBAPP_AUTH_REDIRECT_URL" | "DZ_WEBAPP_URL" | "DZ_WEBAPP_AUTH_SERVICE_GH">> {}
}
