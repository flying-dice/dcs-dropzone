...
import handleAuthResult from "../../application/commands/HandleAuthResult.ts";
import { ErrorData } from "../../application/schemas/ErrorData.ts";
import { UserData } from "../../application/schemas/UserData.ts";
import { AuthServiceFactory } from "../../application/services/AuthService/AuthServiceFactory.ts";
import { AuthServiceProvider } from "../../application/services/AuthService/AuthServiceProvider.ts";
