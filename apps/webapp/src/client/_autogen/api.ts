...
export const getGetLatestModReleaseByIdQueryOptions = <TData = Awaited<ReturnType<typeof getLatestModReleaseById>>, TError = GetLatestModReleaseById404 | ErrorData>(id: string, options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof getLatestModReleaseById>>, TError, TData>>, fetch?: RequestInit}
) => {
...
export const getGetServerMetricsQueryOptions = <TData = Awaited<ReturnType<typeof getServerMetrics>>, TError = ErrorData>( options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof getServerMetrics>>, TError, TData>>, fetch?: RequestInit}
) => {
...
const {query: queryOptions, fetch: fetchOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetServerMetricsQueryKey();
    ...
    const queryFn: QueryFunction<Awaited<ReturnType<typeof getServerMetrics>>> = ({ signal }) => getServerMetrics({ signal, ...fetchOptions });
...
export function useGetServerMetrics<TData = Awaited<ReturnType<typeof getServerMetrics>>, TError = ErrorData>(
  options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof getServerMetrics>>, TError, TData>>, fetch?: RequestInit}
 , queryClient?: QueryClient
  ):  UseQueryResult<TData, TError> & { queryKey: DataTag<QueryKey, TData, TError> }
/**
 * @summary Get Server Metrics
