...
import type { DcsPathError, DropzoneModsDirError, PathResolver } from "./PathResolver.ts";
...
export class RemoveSymlinksScriptManager {
	...
	filePath(): [string, null] | [undefined, DropzoneModsDirError] {
	...
	rebuild(): [void, null] | [undefined, DropzoneModsDirError | DcsPathError] {
