...
import { TestFileSystem, TestPathResolver } from "../__tests__/doubles/index.ts";

describe("PathResolver", () => {
	describe("resolveReleasePath", () => {
		it("resolves release path without additional path", () => {
			const fileSystem = new TestFileSystem();
			const resolver = new TestPathResolver("/dropzone/mods", "/dcs/install", "/dcs/working", fileSystem);
